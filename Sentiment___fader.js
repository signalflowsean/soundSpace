...
def midi_sentiment():
    while True:
        if joyful:
            cc_message = [0xB0, 26, 127] # Send continous control midi message to controller 1
            cc_message = [0xB0, 27, 0] # Send continous control midi message to controller 2
        ...
        if surprised:
            cc_message = [0xB0, 27, 127] # Send continous control midi message to controller 2
            cc_message = [0xB0, 26, 0] # Send continous control midi message to controller 1
            midiout.send_message(cc_message) 
            print("SUPRISE")
            time.sleep(1)
